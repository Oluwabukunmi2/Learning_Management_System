...
{
?><script>
    alert('The Course is Already Enrolled');
    location.assign("enrollnewcourse.php")
          ...
          if (strlen($_SESSION['login']) == 0) {
            ...
            if (isset($_POST['submit'])) {
              ...
              $query = mysqli_query($bd, "insert into enrollnewcourse(fullname,userEmail,enrollcoursename,status) values('$fullname','$userEmail','$enrollcoursename','$status')")  or die(err());
              ...
              <div class="form-panel">
                ...
                <form class="form-horizontal style-form" method="post" name="complaint" enctype="multipart/form-data">
                  ...
                  <div>
                    ...
                    $sqli = mysqli_query($bd, "select * from users where userEmail='$users'");
                    ...
                    $sqli = mysqli_query($bd, "select * from addnewcourse where coursename='$a'");
                    while ($rwi = mysqli_fetch_array($sqli)) {
                      $fname = $rwi['courseid'];
                    }
                    ?>
                    ...
                    <div>
                      ...
                      <select name="enrollcoursename" required="required" class="form-control">
                        ...
                        <?php $sql = mysqli_query($bd, "select * from addnewcourse");
