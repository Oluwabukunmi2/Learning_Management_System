      ...
      <section id="main-content">
        <section class="wrapper">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <select name="slcoursename" id="slcoursename" class="form-control" onChange="getCat(this.value);" required="">
                        ...
                        <?php $sql = mysqli_query($bd, "select slcoursename from uploadstudymeterial");
          ...
          ?>
              ...
              <h2>
                <center><b><a href="\learn\university\complaintdocs\<?php echo $link_veriable; ?>" download>Download</a><a href="\learn\university\complaintdocs\<?php echo $link_veriable; ?>" view>&nbsp; View</a></b></center>
              </h2>
        </section>
    <?php
            }
