...
?>
  ...
  <body>
    ...
    <section id="container">
            ...
            <div class="col-lg-12">
              <div class="form-panel">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <select name="coursename" class="form-control" onChange="getCat(this.value);" required="">
                        ...
                        <?php $sql = mysqli_query($bd, "select coursename from uploadvedio");
                ...
                if (isset($_POST['submit'])) {
                  ...
                  $count = mysqli_query($db, "SELECT websitelink from uploadvedio where coursename='$coursename'");

                  while ($row = mysqli_fetch_array($count)) {

                    $link_veriable = $row['websitelink'];
                  }
                }
                ?>
              </div>
      ...
      <input type="text" name="test" value="fkf" />
      <?php
      echo "<iframe style
='margin-left:500px' width='560' height='315'
src='$link_veriable' frameborder='0'
