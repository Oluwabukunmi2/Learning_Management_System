    ...
    <section id="container">
      ...
      <section id="main-content">
        <section class="wrapper">
          <h3><i class="fa fa-angle-right"></i>Added Courses</h3>
          <div class="row mt">
            <div class="col-lg-12">
                ...
                <section id="unseen">
                  <table class="table table-bordered table-striped table-condensed">
                    ...
                    <tbody>
                      ...
                      $query = mysqli_query($bd, "select * from addnewcourse where uname='$uname'");
                      while ($row = mysqli_fetch_array($query)) {
                      ?>
                        <tr>
                          <td align="center"><?php echo htmlentities($row[0]); ?></td>
                          <td align="center"><?php echo htmlentities($row[1]); ?></td>
                          <td align="center"><?php echo  htmlentities($row[2]);
