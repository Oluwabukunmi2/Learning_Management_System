...
{
?><script>
    alert('The Course is Already Entered');
    location.assign("addnewcourse.php")
          ...
          if (strlen($_SESSION['login']) == 0) {
            ...
            if (isset($_POST['submit'])) {
              ...
              $query = mysqli_query($bd, "insert into addnewcourse(uname,coursename,duration) values('$uname','$coursename','$duration')") or die(err());
              ...
              <div class="form-panel">
                ...
                <form class="form-horizontal style-form" method="post" name="complaint" enctype="multipart/form-data">
                  <div>
                    ...
                    $sqli = mysqli_query($bd, "SELECT * from university where uemail='$university'");
                    while ($rwi = mysqli_fetch_array($sqli)) {
                      $uname = $rwi[2];
                    }
                    ?>
                    <br /> &nbsp;
                    <div class="form-group">
                      <div style="padding-left:10% ">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <input type="text" name="uname" required="required" value="<?php echo "$uname"; ?>" required="" class="form-control">
                          </div><br />
                        </div>
                        ...
                        <div class="form-group">
                          <div style="padding-left:10% ">
                            <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                <input type="text" name="coursename" required="required" value="" required="" class="form-control">
                              </div><br />
                            </div>
