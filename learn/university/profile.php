...
if (strlen($_SESSION['login']) == 0) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($bd, "update university set uname='$uname',contactno='$contactno',address='$address',state='$state',country='$country',pincode='$pincode' where uemail='" . $_SESSION['login'] . "'");
    if ($query) {
...
?>
  ...
  <head>
    ...
    <title>E-Learning | University Profile</title>
          ...
          <div class="row mt">
            <div class="col-lg-12">
              <div class="form-panel">
                ...
                <?php } ?>
                <?php $query = mysqli_query($bd, "select * from university where uemail='" . $_SESSION['login'] . "'");
                while ($row = mysqli_fetch_array($query)) {
                ?>

                  <h4 class="mb"><i class="fa fa-user"></i>&nbsp;&nbsp;<?php echo htmlentities($row['uname']); ?>'s Profile</h4>
                  ...
                  <form class="form-horizontal style-form" method="post" name="profile">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input type="text" name="uname" required="required" value="<?php echo htmlentities($row['uname']); ?>" class="form-control">
                      </div>
                      <label class="col-sm-2 col-sm-2 control-label">User Email </label>
                      <div class="col-sm-4">
                        <input type="email" name="uemail" required="required" value="<?php echo htmlentities($row['uemail']); ?>" class="form-control" readonly>
                      </div>
                    </div>
