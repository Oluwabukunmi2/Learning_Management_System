...
if (strlen($_SESSION['login']) == 0) {
  ...
  if (isset($_POST['submit'])) {
    $sql = mysqli_query($bd, "SELECT password FROM  university where password='" . md5($_POST['password']) . "' && uemail='" . $_SESSION['login'] . "'");
    $num = mysqli_fetch_array($sql);
    if ($num > 0) {
      $con = mysqli_query($bd, "update university set password='" . md5($_POST['newpassword']) . "', updationdate='$currentTime' where uemail='" . $_SESSION['login'] . "'");
...
?>
  ...
  <head>
    ...
    <title>E-Learn | University Change Password</title>
